...
export const mockBudgets = [
  { id: 1, category: 'Entertainment', maximum: 50.0, theme: '#277C78' },
  { id: 2, category: 'Bills', maximum: 750.0, theme: '#82C9D7' },
  { id: 3, category: 'Dining Out', maximum: 75.0, theme: '#F2CDAC' },
  { id: 4, category: 'Personal Care', maximum: 100.0, theme: '#626070' },
];

export const mockPots = [
  { id: 1, name: 'Savings', target: 2000.0, total: 159.0, theme: '#277C78' },
  {
    id: 2,
    name: 'Concert Ticket',
    target: 150.0,
